declare module 'reveal.js' {
	...
	interface Reveal extends RevealStatic {}
	...
	const RevealHighlight: Plugin;
	const RevealMarkdown: Plugin;
	const RevealSearch: Plugin;
	const RevealNotes: Plugin;
	const RevealMath: Plugin;
